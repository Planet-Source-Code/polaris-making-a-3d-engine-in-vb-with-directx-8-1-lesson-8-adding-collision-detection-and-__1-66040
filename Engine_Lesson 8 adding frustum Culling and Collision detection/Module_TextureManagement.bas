...
Public Type QUEST3D_TEXTURE_BLEND
...
Function Add_TextureToPool(TexName As String, Optional ByVal Width As Long = -1, Optional ByVal Height As Long = -1, Optional ByVal ColorKeyARGB As Long = 0) As Long
