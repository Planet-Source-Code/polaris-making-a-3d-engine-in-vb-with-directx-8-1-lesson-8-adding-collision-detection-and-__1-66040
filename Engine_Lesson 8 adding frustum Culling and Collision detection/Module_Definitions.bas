...
Public Const QUEST3D_FVFTLVERTEX = (D3DFVF_XYZRHW Or D3DFVF_DIFFUSE Or D3DFVF_SPECULAR Or D3DFVF_TEX1)


Public Type QUEST3D_TLVERTEX2
    x As Single
    y As Single
    z As Single
    Rhw As Single
...
Public Const QUEST3D_FVFTLVERTEX2 = (D3DFVF_XYZRHW Or D3DFVF_DIFFUSE Or D3DFVF_SPECULAR Or D3DFVF_TEX2)





Public Type QUEST3D_LVERTEX
    x As Single
    y As Single
    z As Single
    color As Long
...
Public Const QUEST3D_FVFLVERTEX = (D3DFVF_XYZ Or D3DFVF_DIFFUSE Or D3DFVF_SPECULAR Or D3DFVF_TEX1)


Public Type QUEST3D_LVERTEX2
    x As Single
    y As Single
    z As Single
    color As Long
...
Public Const QUEST3D_FVFLVERTEX2 = (D3DFVF_XYZ Or D3DFVF_DIFFUSE Or D3DFVF_SPECULAR Or D3DFVF_TEX2)
